...
T0 = 300; DeltaT = T - T0; ECu = 65.79e9; NuCu = 0.387; AlphaCu = 16.51e-6; RoCu = 8800; RoGr = 1800;
...
for k = 1:NL
    ...
    constQ = 1 - Nu_Fin^2;
    Q11_val = Ec_Fin / constQ; Q12_val = Ec_Fin * Nu_Fin / constQ; Q66_val = Ec_Fin / (2*(1+Nu_Fin)); Q44_val = Q66_val; 
    
    constC = (1 + Nu_Fin) * (1 - 2*Nu_Fin);
    C11_3D_val = Ec_Fin * (1 - Nu_Fin) / constC; C12_3D_val = Ec_Fin * Nu_Fin / constC; C33_3D_val = C11_3D_val; 
