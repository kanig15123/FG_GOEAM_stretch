...
for k = 1:NL
    ...
    % DEFINITIONS MUST BE INSIDE THE LOOP SO THEY RE-EVALUATE E AND NU FOR EACH LAYER
...
Lambda0_s_power = lamda0 * a^2 / (ECu * h^3);
Lambda1_s_power = lamda1 * a^2 / (ECu * h^3);
Lambda2_s_power = lamda2 * a^2 / (ECu * h^3);

fprintf('POWER_STRETCH_START\n');
fprintf('No-Stretch:        Lambda0=%.6f, Lambda1=%.6f, Lambda2=%.6f\n', Lambda0_ns, Lambda1_ns, Lambda2_ns);
fprintf('Power-Stretch:     Lambda0=%.6f, Lambda1=%.6f, Lambda2=%.6f\n', Lambda0_s_power, Lambda1_s_power, Lambda2_s_power);
fprintf('POWER_STRETCH_END\n');
