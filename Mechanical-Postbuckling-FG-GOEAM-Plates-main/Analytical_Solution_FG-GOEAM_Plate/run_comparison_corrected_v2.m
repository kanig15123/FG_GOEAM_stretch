...
%% --- 1. RUN WITHOUT STRETCH (STANDARD HSDT) ---
FG_GOEAM; % Standard without stretch
...
%% --- 2. RUN WITH UNCORRECTED STRETCH (AS IN ZIP) ---
...
FG_GOEAM_stretch; % Loads stretch as is
Kun=var6; Ksn=var7; Kln=var8;
Ku=Kun*Dm/(a^4); Kl=Kln*Dm/(a^4); Ks=Ksn*Dm/(a^2);
K1=Kl*Ku/(Kl+Ku); K2=Ks*Ku/(Kl+Ku);
Parameters_stretch;
...
% Manually execute the corrected integrations
T0 = 300;
DeltaT = T - T0;
...
for k = 1:NL
    ...
    a21=integral(Q12a, z_bot, z_top, 'ArrayValued', true); % Fix symmetry
    ...
    b21=integral(Q12b, z_bot, z_top, 'ArrayValued', true); % Fix symmetry
    ...
    d21=integral(Q12d, z_bot, z_top, 'ArrayValued', true); % Fix symmetry
    ...
    e21=integral(Q12e, z_bot, z_top, 'ArrayValued', true); % Fix symmetry
    ...
    f21=integral(Q12f, z_bot, z_top, 'ArrayValued', true); % Fix symmetry
    ...
    h21=integral(Q12h, z_bot, z_top, 'ArrayValued', true); % Fix symmetry
